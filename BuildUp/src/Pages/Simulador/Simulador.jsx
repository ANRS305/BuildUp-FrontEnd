    ...
    return (
        <>
                        ...
                        {resultado && (
                            <div className="chat-ajuda-card">
                                ...
                                <p>
                                    ...
                                    ou tirar dúvidas, consulte o Chat BuildUp IA.
                                </p>
                                <button
                        ...
                        {resultado ? (
                            <>
                                ...
                                <div className="info-box destaque">
                                    ...
                                    <p>
                                        {Number(resultado.total).toLocaleString(
                                            "pt-BR",
                                            {
                                                style: "currency",
                                                currency: "BRL"
                            ...
                            <div className="vazio">
                                ...
                                para visualizar a estimativa de materiais e custos.
                            </div>
                        )}
                    </div>
                </div>
            ...
            <Modal
                ...
                onFechar={() =>
                    setModal({ aberto: false, titulo: "", mensagem: "" })
                }
            />
        </>
    );
