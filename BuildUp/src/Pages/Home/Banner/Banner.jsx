...
export default function Banner() {
  ...
  return (
    <section className="banner">
      {/*Img Fundo*/}
      <img src={imagens[imagemAtual]} alt="" className="banner-background" />
      ...
      <div className="banner-content">
        ...
        <p>
          Simule custos, encontre profissionais qualificados e economize tempo e
          dinheiro do início ao fim da sua construção ou reforma.
        </p>
