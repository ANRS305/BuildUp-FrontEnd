        ...
        <section className="cards">
            ...
            <div className="benefits">
                <div className="benefits-header hidden">
                    <h2>
                        Por que escolher o BuildUp?
                    </h2>
                    <p>
                        Tecnologia inteligente para transformar
                        sua construção em uma experiência simples.
                    </p>
                </div>
                <div className="benefits-container">
                    ...
                    <div className="benefit-card hidden">
                        ...
                        <p>
                            Compare preços e encontre as melhores
                    ...
                    <div className="benefit-card hidden">
                        ...
                        <p>
                            Contrate profissionais avaliados
                    ...
                    <div className="benefit-card hidden">
                        ...
                        <p>
                            ...
                            para planejar sua obra com precisão.
                        </p>
                    </div>
                </div>
            </div>
